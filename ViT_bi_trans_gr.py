...
def train(tr_dataloader, model, optim, scheduler, val_dataloader=None):
    ...
    torch.save(model.state_dict(), 'models/paper_params/ViT_bi_trans_gr.pth')
...
if __name__ == "__main__":
    ...
    model = model.cuda()
    model.load_state_dict(torch.load('models/paper_params/ViT_bi.pth'))
