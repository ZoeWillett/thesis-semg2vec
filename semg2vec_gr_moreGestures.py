...
def train(tr_dataloader, model, optim, scheduler, val_dataloader=None):
    ...
    torch.save(model.state_dict(), 'models/paper_params/semg2vec_gr_moreGestures.pth')
...
if __name__ == "__main__":
    ...
    model_a.load_state_dict(torch.load('models/paper_params/semg2vec_gr_pred_reduced.pth'))
